#
#  Be sure to run `pod spec lint ketan.podspec' to ensure this is a
...
Pod::Spec.new do |s|
  ...
  s.description  = "This is short description. We are using this description"
 ...
 s.swift_version = "4.2"
  ...
  s.source       = { :git => "https://github.com/ketandhoka/MySDK.git", :tag => "#{s.version}" }
  ...
  s.vendored_frameworks = 'DigiAdz/DigiAdz.framework','HyprMX/HyprMX.framework','IronSourceSDK/IronSource.framework'
